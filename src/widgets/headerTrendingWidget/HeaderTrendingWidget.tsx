...
const HeaderTrendingWidget = () => {
	...
	const bgImage = track?.imageUrl
		? `linear-gradient(120deg, rgba(35, 37, 61, 0.95) 60%, rgba(0,0,0,0.8)), url(${track.imageUrl})`
		: undefined
				...
				<div className={styles.content}>
					...
					<div className={styles.meta}>
						<h1 className={styles.title}>
							Trending songs <span className={styles.highlight}>mix</span>
						</h1>

						<h2>
							{track.title}{' '}
							<span className={styles.highlight}>{track.artist}</span>
						</h2>
						<p>{track.album}</p>
...
export default HeaderTrendingWidget
